...
<head>
    ...
    <!-- Title -->
    <title>Gallery | SafeNet eToken 5110 USB Authenticator</title>
...
<body>
    ...
    <section class="pricing-plane-area section_padding_100_70 clearfix" id="pricing">
        ...
        <ul>
			<li>Improves productivity by allowing employees and partners to securely access corporate resources</li>
			<li>Enables advanced certificate-based applications, such as digital signature and pre-boot authentication</li>
			<li>Common Criteria and FIPS certified versions available</li>
			<li>Portable USB token: no special reader needed</li>
			<li>Simple and easy to use no training or technical knowhow needed</li>
			<li>Expand security applications through on-board Java applets</li>
			<li>Enhance marketing and branding initiatives with private labeling and color options.</li>
			</ul>
			
			<h3>Supported Applications</h3>
			<ul>
			<li>Secure remote access to VPNs and Web portals and Cloud Services</li>
			<li>Secure network logon</li>
