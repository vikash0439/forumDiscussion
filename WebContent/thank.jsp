...
<head>
    ...
    <meta name="description" content="Gemalto SafeNet Identity and Data Protection solutions are trusted by the largest and most respected brands around the world to protect what matters most.">    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <!-- The above 4 meta tags *must* come first in the head; any other head content must come *after* these tags -->

    <!-- Title -->
    <title>Thank You | SafeNet eToken 5110 USB Authenticator</title>
    ...
    <section class="pricing-plane-area section_padding_100_70 clearfix" id="pricing">
        <div class="container">
           <div class="row">
            ...
            <center> <img src="img/thankyou.jpg"> <br><br>
            <p>Thank you for your interest in Safenet eToken.</p></center>
        </div>
    </section>
